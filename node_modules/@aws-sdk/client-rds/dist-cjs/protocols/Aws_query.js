...
const de_DomainMembership = (output, context) => {
    ...
    if (output["OU"] !== undefined) {
        contents.OU = (0, smithy_client_1.expectString)(output["OU"]);
    }
    if (output["AuthSecretArn"] !== undefined) {
        contents.AuthSecretArn = (0, smithy_client_1.expectString)(output["AuthSecretArn"]);
    }
    if (output.DnsIps === "") {
        contents.DnsIps = [];
    }
    else if (output["DnsIps"] !== undefined && output["DnsIps"]["member"] !== undefined) {
        contents.DnsIps = de_StringList((0, smithy_client_1.getArrayIfSingleItem)(output["DnsIps"]["member"]), context);
    }
    return contents;
};
